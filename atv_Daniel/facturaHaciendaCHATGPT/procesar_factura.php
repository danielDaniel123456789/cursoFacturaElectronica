...
// Generar XML
$xmlFactura = generarXMLFactura($config['emisor'], $cliente, [
    'detalle' => $cliente['detalle'],
    'cabys' => $cliente['cabys'],
    'monto' => $cliente['monto'],
], $consecutivo, $clave, $fecha_emision);
...
// Firmar XML
list($exitoFirma, $xmlFirmado) = firmarXML($xmlFactura, $config['certificado']['ruta'], $config['certificado']['clave']);
